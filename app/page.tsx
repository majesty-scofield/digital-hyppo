    ...
    const perks = [
        {
            ...
            description: "Get your item delivered in your email address in seconds and download them right away.",
        },
        {
        ...
        },
        {
            name: "For the planet",
            Icon: Leaf,
            description: "we've pledged 1% of sales to the reservation and restoration of the natural environment.",
        },
    ]
    return (
        <>
            <MaxWidthWrapper>
                <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
                    <h1 className='text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl'>Your marketplace for
                        high-quality
                        <span className='text-blue-600'>digital assets</span>.
                    </h1>
                    <p className='mt-6 text-lg max-w-prose text-muted-foreground'>Welcome to DigitalHyppo.
